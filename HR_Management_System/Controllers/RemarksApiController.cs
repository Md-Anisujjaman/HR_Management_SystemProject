...
namespace HR_Management_System.Controllers
{
    ...
    public class RemarksApiController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Object>>> GetRemarks()
        {
            try
            {
               var data= _context.Remarks.Select(r=>new{remarkId=r.RemarkId,employeeId=r.Employee.EmployeeId,fullName=r.Employee.FullName,comments=r.Comments, managerName = r.Manager.ManagerName}).ToList();
                return data;
            }
            catch (Exception e)
            {
